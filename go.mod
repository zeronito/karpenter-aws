...
require (
	...
	sigs.k8s.io/karpenter v0.37.4-0.20240925000401-46bab1b6a31f
	sigs.k8s.io/yaml v1.4.0
)

replace sigs.k8s.io/karpenter => github.com/jonathan-innis/karpenter v0.0.4-0.20240926171334-34ca31ee02f1
